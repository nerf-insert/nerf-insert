...
@dataclass
class NeRFInsertTrainerConfig(TrainerConfig):
    """Configuration for the NeRFInsertTrainer."""
    _target: Type = field(default_factory=lambda: NeRFInsertTrainer)


class NeRFInsertTrainer(Trainer):
    """Trainer for NeRFInsert"""
    ...
    def __init__(self, config: TrainerConfig, local_rank: int = 0, world_size: int = 1) -> None:
        ...
        #self.pipeline.n_steps = self.config.max_num_iterations
